      ...
      <FormProvider {...methods}>
        ...
        >
          ...
          <div className="pr-4 text-right">
            <button
              onClick={onSubmit}
              className="0 after:bg-opacity-0 after:hover:bg-opacity-15 inline-flex h-fit w-fit rounded-full border border-blue-100/20 bg-blue-200/10 px-4 py-2 text-blue-200 ring-yellow-300 transition-colors outline-none after:inset-0 after:animate-pulse after:rounded-full after:bg-yellow-100 after:blur-md after:transition-all after:duration-500 hover:cursor-pointer hover:border-yellow-200/40 hover:text-yellow-300 focus:ring-2"
            >
              Send Email
            </button>
          </div>
